...
begin
      ...
      s:= 'select month(Tanggal) Bulan,year(Tanggal) Tahun,Tanggal,Nomor,Referensi,Account,AccountName,Keterangan,Debet,Kredit,Kelompok,CostCenter'
                  + ' from alljurnal'
  ...
  ds3.Close;
        ...
        Skolom :='Bulan,Tahun,Tanggal,Nomor,Referensi,Account,AccountName,Keterangan,Debet,Kredit,Kelompok,CostCenter';
