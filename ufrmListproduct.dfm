object frmListProduct: TfrmListProduct
  Left = 336
  Top = 93
  Width = 758
  Height = 565
  ...
  object MyQuery1: TMyQuery
    ...
    SQL.Strings = (
      'select item_id Kode,item_nama nama,item_harga Harga from titem'
      'limit 1')
    Left = 224
    Top = 144
    object MyQuery1Kode: TIntegerField
      FieldName = 'Kode'
    end
    ...
    object MyQuery1Harga: TFloatField
      FieldName = 'Harga'
    end
  end
