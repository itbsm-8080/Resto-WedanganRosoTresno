object frmsalestype: Tfrmsalestype
  Left = 323
  Top = 129
  Width = 872
  Height = 543
  ...
  object MyQuery1: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select st_id id ,st_nama nama ,st_sc Sc,st_tax Tax from tsalesty' +
        'pe')
    Left = 224
    Top = 144
    ...
    object MyQuery1Sc: TIntegerField
      FieldName = 'Sc'
    end
    object MyQuery1Tax: TIntegerField
      FieldName = 'Tax'
    end
  end
