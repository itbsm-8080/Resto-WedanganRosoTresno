object frmModifier: TfrmModifier
    ...
    object cxGrid3: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        object cxGridDBColumn1: TcxGridDBColumn
          Caption = 'Item Id'
          DataBinding.FieldName = 'mdi_item'
          Width = 62
        end
  ...
  object MyQuery1: TMyQuery
    ...
    SQL.Strings = (
      'select md_id id ,md_nama nama,md_option Opsi from tmodifier')
    Left = 224
    Top = 144
    ...
    object MyQuery1Opsi: TStringField
      FieldName = 'Opsi'
      Size = 100
    end
  end
  ...
  object MyQuery2: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select mdo_nama nama,mdo_price price from tmodifieroption limit ' +
        '0')
    Left = 216
    Top = 192
    object MyQuery2nama: TStringField
      FieldName = 'nama'
      Origin = 'tmodifieroption.mdo_nama'
      Size = 30
    end
    object MyQuery2price: TFloatField
      FieldName = 'price'
      Origin = 'tmodifieroption.mdo_price'
    end
  end
  ...
  object MyQuery3: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select mdi_item,item_nama nama from tmodifieritem inner join tit' +
        'em on mdi_item=item_id'
      'limit 0')
    Left = 216
    Top = 272
    object MyQuery3mdi_item: TStringField
      FieldName = 'mdi_item'
      Origin = 'tmodifieritem.mdi_item'
      Size = 30
    end
    object MyQuery3nama: TStringField
      FieldName = 'nama'
