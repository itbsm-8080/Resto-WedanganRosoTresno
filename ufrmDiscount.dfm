object frmDiscount: TfrmDiscount
  ...
  object MyQuery3: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select discd_disc_id id,discd_category nama from tdiscountitem l' +
        'imit 0')
    Left = 216
    Top = 272
    object MyQuery3id: TIntegerField
      FieldName = 'id'
      Origin = 'tdiscountitem.discd_disc_id'
    end
    object MyQuery3nama: TStringField
      FieldName = 'nama'
      Origin = 'tdiscountitem.discd_category'
      Size = 30
    end
  end
  ...
  object MyQuery1: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select disc_id id ,disc_nama nama,disc_persen Discount from tdis' +
        'count')
    Left = 224
    Top = 144
    ...
    object MyQuery1Discount: TFloatField
      FieldName = 'Discount'
    end
  end
