object frmKoreksiStok: TfrmKoreksiStok
  ...
  object AdvPanel1: TAdvPanel
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGrid2DBTableView1: TcxGridDBTableView
        ...
        object cxGrid2DBTableView1Column3: TcxGridDBColumn
          ...
          Properties.OnButtonClick = cxGrid2DBTableView1Column3PropertiesButtonClick
          Width = 74
        end
    ...
    object dtTanggal: TDateTimePicker
      ...
      Width = 333
      Height = 26
      Date = 44777.555630069440000000
      Time = 44777.555630069440000000
      Font.Charset = ANSI_CHARSET
      Font.Color = clSilver
      Font.Height = -13
      Font.Name = 'Trebuchet MS'
  ...
  object AdvPanel2: TAdvPanel
    ...
    object dttanggalshow: TDateTimePicker
      Left = 176
      Top = 7
      Width = 113
      Height = 26
  ...
  object MyQuery1: TMyQuery
    ...
    SQL.Strings = (
        ...
        'select sti_nomor Nomor,sti_tanggal Tanggal,sti_keterangan Ketera' +
        'ngan'
      'from tstokin limit 1')
    Left = 224
    Top = 144
    object MyQuery1Nomor: TStringField
      FieldName = 'Nomor'
    end
    object MyQuery1Tanggal: TDateField
      FieldName = 'Tanggal'
    end
    object MyQuery1Keterangan: TStringField
  ...
  object MyQuery2: TMyQuery
    Connection = frmMenu.MyConnection1
    SQL.Strings = (
      'select item_id Kode,item_nama Nama,CAST(0 AS UNSIGNED)  stok'
      ',CAST(0 AS UNSIGNED)  Fisik ,CAST(0 AS UNSIGNED)  Selisih '
      'from titem limit 0')
    Left = 216
    Top = 192
    object MyQuery2Kode: TIntegerField
      FieldName = 'Kode'
    end
    ...
    object MyQuery2stok: TLargeintField
      FieldName = 'stok'
    end
    object MyQuery2Fisik: TLargeintField
      FieldName = 'Fisik'
    end
    object MyQuery2Selisih: TLargeintField
      FieldName = 'Selisih'
    end
  end
  ...
  object MyQuery3: TMyQuery
    Connection = frmMenu.MyConnection1
    SQL.Strings = (
      'select item_id , foto from titem')
    Left = 208
    Top = 256
    object MyQuery3item_id: TIntegerField
      FieldName = 'item_id'
    end
    object MyQuery3foto: TBlobField
      FieldName = 'foto'
    end
  end
